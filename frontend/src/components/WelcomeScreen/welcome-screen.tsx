...
import { ArrowRight, Users2, Sparkles, Crown, PlayCircle } from "lucide-react";
import { motion, type Variants } from "framer-motion";

// Интерфейс для описания характеристик
interface Feature {
...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ isAunticated }) => {
  const router = useRouter();

  // Список характеристик платформы
  ...
  // Обработчик перехода на список аниме
  const handleAnimeListClick = React.useCallback(() => {
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 mb-8 max-w-2xl mx-auto">
              Погрузитесь в мир аниме с удобной платформой для просмотра и управления вашей
              коллекцией
            </p>
