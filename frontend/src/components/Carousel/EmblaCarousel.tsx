                        ...
                        <div className="embla__slide" key={anime.anime_id}>
                            <TooltipProvider>
                                <Tooltip delayDuration={700} skipDelayDuration={0}>
                                    ...
                                    <TooltipContent side="right" className="p-0 bg-black/95 backdrop-blur border-white/[0.06]">
                                            ...
                                            <div className="grid grid-cols-3 gap-4">
                                                ...
                                                {anime.aired_on && (
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <p className="text-[13px] text-white/90 font-medium">{new Date(anime.aired_on).getFullYear()}</p>
                                                    </div>
                                                )}
                                            </div>
                                                    ...
                                                    <div className="flex flex-wrap gap-1.5">
                                                        {anime.genre_ids
                                                            .map(genreId => {
                                                                ...
                                                                return genre ? { id: genreId, name: genre.russian || genre.name } : null;
                                                            })
