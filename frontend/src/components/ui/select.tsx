...
// Корневой компонент выпадающего списка
export const Select = SelectPrimitive.Root;

// Группа элементов выпадающего списка
...
/**
 * Кнопка прокрутки вверх в выпадающем списке
...
/**
 * Кнопка прокрутки вниз в выпадающем списке
 * @param props Пропсы кнопки
 */
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={mergeClass("px-2 py-1.5 text-sm font-semibold", className)}
    {...props}
  />
));
