...
// Корневой компонент боковой панели
export const Sheet = SheetPrimitive.Root;

// Триггер для открытия боковой панели
export const SheetTrigger = SheetPrimitive.Trigger;

// Кнопка закрытия боковой панели
export const SheetClose = SheetPrimitive.Close;

// Портал для рендеринга боковой панели
...
// Варианты стилей для контента боковой панели
...
// Пропсы контента боковой панели
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={mergeClass(sheetVariants({ side }), className)}
      {...props}
    >
      {children}
...
// Заголовок текста боковой панели
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={mergeClass("text-lg font-semibold text-foreground", className)}
    {...props}
  />
));
